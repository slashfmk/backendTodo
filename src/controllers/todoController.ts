...
// TODO new todo
export const addTodo = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    ...
    try {
        ...
        db.query(sql, [title, description, true], (error: MysqlError, results: any, fields: FieldInfo[]) => {
...
// TODO get todos
export const getAllTodos = (req: express.Request, res: express.Response, next: express.NextFunction) => {
